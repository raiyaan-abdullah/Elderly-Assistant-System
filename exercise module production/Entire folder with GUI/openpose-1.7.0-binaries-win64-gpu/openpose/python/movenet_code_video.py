...
cv2.destroyAllWindows()
 '''
files = glob.glob('movenet/live_json/1/*')
for f in files:
    os.remove(f)
os.system('python openpose_python.py --video movenet/record.mp4 --net_resolution 528x272 --write_json movenet/live_json/1/')