...
MAIN_LOCATION = 'D:/Github Projects/Elderly-Assistant-System/exercise_module/data/Arm Movement 2 normal + flipped augmented 5x/'
...
augment_images(train_bad_no+total*2 ,MAIN_LOCATION+'\\train\good')
augment_images(train_good_no+total*2 ,MAIN_LOCATION+'\\train\\bad')
