...
filepath="D:/Github Projects/Elderly-Assistance-System/elderly_assistance_system/exercise_module/image_plot/trained_models/ex_3/5x/exercise_predict_3_5x_resnet.{epoch:02d}-{val_loss:.2f}.hdf5"
...
#save the model
model.save("exercise_quality_3_5x_resnet.hdf5")
