...
filepath="D:/Github Projects/Elderly-Assistant-System/exercise_module/trained_models/arm_abduction_and_adduction/5x/exercise_predict_1b_5x_mobilenet_v2.{epoch:02d}-{val_loss:.2f}.hdf5"
...
def define_model():
    ...
    opt = Adam(learning_rate=0.00005) #.0005 for ex 1b 
...
#save the model
model.save("exercise_quality_1b_5x_mobilenet_v2.hdf5")
