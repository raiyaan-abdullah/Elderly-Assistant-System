...
filepath="D:/Github Projects/Elderly-Assistance-System/elderly_assistance_system/exercise_module/image_plot/trained_models/ex_2/5x/exercise_predict_2_5x.{epoch:02d}-{val_loss:.2f}.hdf5"
...
def define_model(video_y , video_x):
    ...
    model.add(Conv2D(10, (5, 5), activation='relu',input_shape=(video_y , video_x, 3))) #64 (3,3) for exercise 1a
    #model.add(BatchNormalization())
    model.add(MaxPooling2D((5, 5)))
    model.add(Conv2D(20, (5, 5), activation='relu')) #64 (3,3) for exercise 1a
    '''model.add(BatchNormalization())
    model.add(MaxPooling2D((3, 3)))
    model.add(Conv2D(128, (5, 5), activation='relu')) #64 (3,3) for exercise 1a
    model.add(BatchNormalization())
    model.add(MaxPooling2D((3, 3)))'''
...
#save the model
model.save("exercise_quality_2_5x.hdf5")
